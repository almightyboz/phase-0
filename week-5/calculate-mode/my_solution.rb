...
# We used select, keys, max, max_by, and a new (to me) method called has_key?(). I learned more about max() and values() while refactoring. They were all good methods and I had minimal trouble implementing them. I found more when I was googling other solutions to this problem which used (among other things) size, inject, find_all, flatten, and uniq.