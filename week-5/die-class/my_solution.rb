...
# 4. Reflection
# One raises an ArgumentError in a class's method to notify that one is using unacceptable arguments. Meaning, you will get an odd number or an error farther down the line if the unacceptable argument is initialized as the instance variable.
