...
//
//I had trouble passing test 8. What helped me was reading closely over the exercise. I realized that it was asking me to add a property, but use object-literal notation to denote that the property is an object in itself. From there, it wasn't hard to infer that I had to assign "traits" to the object carter by going in through the terah object and the children property/object.
// I didn't find it too difficult to add and delete properties, the theory is the same as Ruby. The difficult thing for me is remembering what "things" are properties, what are objects, and what are both. (Where "thing" is an inexact word.)
// I learned that defining an object and manipulating it's properties are two very different processes in JavaScript.
//
//
